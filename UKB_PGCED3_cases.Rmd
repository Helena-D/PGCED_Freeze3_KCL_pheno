...
saveRDS(object = dat_interim, file = paste0("/scratch/groups/ukbiobank/usr/helena_d/UKB_PGCED_Freeze3_final_files/interim_death_MHQ_HES_UKB_PGCED3_case_data.rds"))
```
...
Save data so far
```{r save data}
saveRDS(object = dat, paste0("/scratch/groups/ukbiobank/usr/helena_d/UKB_PGCED_Freeze3_final_files/interim2_death_MHQ_HES_GP_UKB_PGCED3_case_data.rds"))
```
...
saveRDS(object = all_variables_case_dat,
        file = paste0("/scratch/groups/ukbiobank/usr/helena_d/UKB_PGCED_Freeze3_final_files/UKB_PGCED3_all_case_data_070322.rds")) # NB: Have a separate .rmd for file formatting for Plink and regenie
```
...
saveRDS(object = only_case_dat, file = paste0("/scratch/groups/ukbiobank/usr/helena_d/UKB_PGCED_Freeze3_final_files/UKB_PGCED3_only_case_data_070322.rds")) # NB: Have a separate .rmd for file formatting for Plink and regenie
```
...
centre_info <- read_tsv(file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/lee/UKB_PGC_ED/UKB_PGCED3_covariates_aligned.txt")
...
write_tsv(covar_dat_batch_PC_centre_DENTIST_no_NA,
          file = "/scratch/groups/ukbiobank/usr/helena_d/UKB_PGCED_Freeze3_final_files/UKB_PGCED3_covariates_merged_PC_batch_no_NA_DENTIST.txt")
```
